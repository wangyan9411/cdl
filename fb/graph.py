...
class api:
        ...
        #This method is used for retrieving objects from facebook with keyword
        def get_query_object(self, keyword):
                res=request.get_object_cat2(self.con, self.token, keyword)
                return res
